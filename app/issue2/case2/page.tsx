  ...
  return (
    <div className="min-h-screen custom text-[#195BA2] px-6 py-16">
      ...
      <div className="md:max-w-7xl mx-auto text-center mb-12">
        ...
        <h1 className="pt-4 sm:mx-8 sm:text-[30px] text-[20px] font-light ">IVUS-GUIDED ROTATIONAL ATHERECTOMY–ASSISTED PCI FOR A LONG, SEVERELY CALCIFIED LAD LESION IN A CHIP PATIENT
      ...
      <section className="max-w-5xl mx-auto text-center mb-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 justify-items-center">
          ...
          >
            <AuthorCard
              title="Dr. Lal Daga"
              experience="MBBS(M), DNB(Med), DrNB(Cardiology), MNAMS, FAPSIC, FSCAI, FESC"
              designation="Senior Consultant and Interventional Cardiologist"
              department="Department of Cardiology"
              hospital="Apollo Hospitals International"
              location="Ahmedabad, Gujarat, India"
              image="https://rosuvasheartinterventions.com/assets/author-images/2-3.png"
            />
          </motion.div>
      ...
      <section className="max-w-7xl mx-auto mb-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          {/* Videos 1A and 1B */}
          <VideoCard
            videoSrc="https://rosuvasheartinterventions.com/assets/issue2case2assets/1A.mp4"
            title="Video 1"
            about="Rota burr of 1.5 in a severely diseased long LAD @ 1,80,000 rpm"
          />
          <VideoCard
            videoSrc="https://rosuvasheartinterventions.com/assets/issue2case2assets/1B.mp4"
            title="Video 2"
            about="After a successful Rotablation & PTCA + stenting to LAD with 2 Drug eluting stents"
          />
