    ...
    <div className="min-h-screen custom text-[#195BA2] px-6 py-16">
      ...
      <div className="md:max-w-7xl mx-auto text-center mb-12">
        <button className="hover:bg-[#195BA2] duration-200 text-[#6d6e71] hover:text-white text-4xl border-2 border-[#195BA2] rounded-md">
          <p className="px-4 font-light py-2">Issue 4 - Case 3</p>
        </button>
        <h1 className="pt-4 sm:mx-8 sm:text-[30px] text-[20px] font-light">
          IVUS-GUIDED IMPELLA SUPPORTED COMPLEX LEFT MAIN BIFURCATION PCI: ADJUNCTIVE USE OF ROTATIONAL ATHERECTOMY AND INTRAVASCULAR LITHOTRIPSY
        </h1>
      ...
      <section className="max-w-5xl mx-auto text-center mb-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 justify-items-center">
          ...
          >
            <AuthorCard
              title="Dr. Karishma Pareek"
              experience="MD"
              designation="Clinical Fellow in Cardiovascular Medicine"
              department="Department of Cardiology"
              hospital="University of Vermont Medical Center"
              location="Burlington, Vermont"
              image="https://rosuvasheartinterventions.com/assets/issue4authors/karishma.png"
            />
          </motion.div>
          <motion.div
            initial={{ opacity: 0, x: -100 }}
          ...
          >
            <AuthorCard
              title="Dr. Tanush Gupta"
              experience="MD"
              designation="Interventional and Structural Cardiologist"
              department="Department of Cardiology"
              hospital="University of Vermont Medical Center"
              location="Burlington, Vermont"
              image="https://rosuvasheartinterventions.com/assets/issue4authors/gupta.png"
            />
          </motion.div>
        </div>
      </section>
