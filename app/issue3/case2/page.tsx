    ...
    <div className="min-h-screen custom text-[#195BA2] px-6 py-16">
      ...
      <div className="md:max-w-7xl mx-auto text-center mb-12">
        ...
        <button className="hover:bg-[#195BA2] duration-200 text-[#6d6e71] hover:text-white text-4xl border-2 border-[#195BA2] rounded-md">
          <p className="px-4 font-light py-2">Issue 3 - Case 2</p>
        </button>
        <h1 className="pt-4 sm:mx-8 sm:text-[30px] text-[20px] font-light">
          PRECISION WITHOUT IMPLANT: LEAVING NOTHING BEHIND
        </h1>
      ...
      <section className="max-w-5xl mx-auto text-center mb-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 justify-items-center">
          ...
          >
            <AuthorCard
              title="Dr. Pooja S Parab"
              experience="DM (Cardiology)"
              designation="Assistant Professor"
              department="Department of Cardiology"
              hospital="Lokmanya Tilak Municipal Medical College and Government Hospital"
              location="Mumbai, Maharashtra, India"
              image="https://rosuvasheartinterventions.com/assets/author-images/puja.png"
            />
          </motion.div>
          <motion.div
            initial={{ opacity: 0, x: -100 }}
          ...
          >
            <AuthorCard
              title="Dr. Milind S Phadke"
              experience="DM (Cardiology)"
              designation="Additional Professor"
              department="Department of Cardiology"
              hospital="Lokmanya Tilak Municipal Medical College and Government Hospital"
              location="Mumbai, Maharashtra, India"
              image="https://rosuvasheartinterventions.com/assets/author-images/milind.png"
            />
          </motion.div>
          <motion.div
            initial={{ opacity: 0, x: -100 }}
          ...
          >
            <AuthorCard
              title="Dr. Kirti Punamiya"
              experience="DM (Cardiology)"
              designation="Consultant"
              department="Department of Cardiology"
              hospital="Breach Candy Hospital Trust"
              location="Mumbai, Maharashtra, India"
              image="https://rosuvasheartinterventions.com/assets/author-images/kirti.png"
            />
          </motion.div>
        </div>
      </section>
