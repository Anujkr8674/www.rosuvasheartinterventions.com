    ...
    <div className="min-h-screen custom text-[#195BA2] px-6 py-16">
      ...
      <div className="md:max-w-7xl mx-auto text-center mb-12">
        ...
        <button className="hover:bg-[#195BA2] duration-200 text-[#6d6e71] hover:text-white text-4xl border-2 border-[#195BA2] rounded-md">
          <p className="px-4 font-light py-2">Issue 3 - Case 1</p>
        </button>
        <h1 className="pt-4 sm:mx-8 sm:text-[30px] text-[20px] font-light">
          PERFORATION AND PERIL: IATROGENIC CORONARY CAMERAL FISTULA POST-RCA CTO PER CUTANEOUS CORONARY INTERVENTION
        </h1>
      ...
      <section className="max-w-5xl mx-auto text-center mb-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 justify-items-center">
          ...
          >
            <AuthorCard
              title="Dr. Aditya Batra"
              experience="MD DM (Cardiology) FACC FESC PSCAI FAPSIC"
              designation="Chief Interventional Cardiologist"
              department="Department of Cardiology"
              hospital="Holy Heart Advanced Cardiac Care and Research Centre"
              location="Rohtak, Haryana, India"
               image="https://rosuvasheartinterventions.com/assets/author-images/aditya.png"
            />
          </motion.div>
        </div>
      </section>
