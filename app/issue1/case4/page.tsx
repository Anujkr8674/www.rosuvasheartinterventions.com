  ...
  return (
    ...
    <p className='px-4 font-light py-2'>
      Issue 1 - Case 4
          ...
          <h1 className="pt-4   sm:mx-8 sm:text-[30px] text-[20px] font-light ">PRECISION PCI FOR OSTIAL DISEASE: LEFT MAIN BIFURCATION WITH OSTIAL LAD, LCX, AND D1 TREATMENT USING IVUS, DES, AND DEB</h1>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 justify-items-center">
      ...
      >
        <AuthorCard
          title="Dr. Viveka Kumar"
          qualification={"MD, DM, FSCAI, FACC, FECS, APFIC, FRCP (Edin)"}
          experience="Chairman"
          department={"Department of Cardiology"}
          hospital={"Max Super Speciality Hospital, Saket"}
          location={"New Delhi, India"}
          image="https://rosuvasheartinterventions.com/assets/author-images/7.png"
        />
      </motion.div>
    </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto mb-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
           ...
           <VideoCard
            videoSrc="https://rosuvasheartinterventions.com/assets/issue1case4assets/video1_web.mp4"
            title="Video 1"
            about="WARSID_PRE LAD_01_Color"
          />
