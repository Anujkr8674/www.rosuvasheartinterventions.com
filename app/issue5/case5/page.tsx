    ...
    <div className="min-h-screen custom text-[#195BA2] px-6 py-16">
      ...
      <div className="md:max-w-7xl mx-auto text-center mb-12">
        <button className="hover:bg-[#195BA2] duration-200 text-[#6d6e71] hover:text-white text-4xl border-2 border-[#195BA2] rounded-md">
          <p className="px-4 font-light py-2">Issue 5 - Case 5</p>
        </button>
        <h1 className="pt-4 sm:mx-8 sm:text-[30px] text-[20px] font-light">
          IMPELLA CP SUPPORTED PCI-ROTA-TRIPSY FOR HEAVILY CALCIFIED CRITICAL LEFT MAIN BIFURCATION WITH LV DYSFUNCTION AND MULTIPLE COMORBIDITIES
        </h1>
      ...
      <section className="max-w-5xl mx-auto text-center mb-20">
        ...
        <div className="grid grid-cols-1 gap-8 justify-items-center">
          <motion.div initial={{ opacity: 0, x: -100 }} whileInView={{ opacity: 1, x: 0 }} transition={{ duration: 0.8 }} viewport={{ once: true }}>
            <AuthorCard
              title="Dr. Sanjeev K Sharma"
              experience="MD DM (AIIMS) FACC FSCAI FESC"
              designation="Chairman"
              department="Department of Interventional Cardiology"
              hospital="Eternal Hospital Care Centre"
              location="Jaipur, Rajasthan, India"
              image="https://rosuvasheartinterventions.com/assets/issue5authors/sanjeev.png"
            />
          </motion.div>
        </div>
      </section>
